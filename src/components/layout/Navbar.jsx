    ...
    return (
        <header className="sticky top-0 z-40 border-b border-black/5 bg-white/70 backdrop-blur dark:border-white/5 dark:bg-zinc-950/70">
            <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3">
                <button onClick={onBack} className="text-sm text-zinc-600 dark:text-zinc-300 hover:text-black dark:hover:text-white mr-2">
                    &larr; Back to Profiles
                </button>
                <div className="ml-auto text-xl font-extrabold tracking-tight">
